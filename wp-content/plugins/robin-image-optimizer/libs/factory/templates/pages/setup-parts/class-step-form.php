...
class Step_Form extends Step {
	...
	protected function render_form( \Wbcr_FactoryForms600_Form $form ) {
		?>
		<form method="post" id="w-factory-templates-759__setup-form-<?php echo $this->get_id(); ?>" class="w-factory-templates-759__setup-form form-horizontal">
			<?php $form->html(); ?>
			<div class="w-factory-templates-759__form-buttons">
				<!--<input type="submit" name="skip_button_<?php /*echo $this->get_id() */ ?>" class="button-primary button button-large w-factory-templates-759__skip-button" value="<?php /*_e('Skip', 'wbcr_factory_templates_759') */ ?>">-->
				<input type="submit" name="continue_button_<?php echo $this->get_id(); ?>" class="button-primary button button-large w-factory-templates-759__continue-button" value="<?php _e( 'Continue', 'robin-image-optimizer' ); ?>">
			</div>
		</form>
		<?php
	}

	protected function set_form_handler( \Wbcr_FactoryForms600_Form $form ) {
	...
	public function html() {
		...
		<div id="WBCR" class="wrap">
			<div class="wbcr-factory-templates-759-impressive-page-template factory-bootstrap-500 factory-fontawesome-000">
				<div class="w-factory-templates-759-setup__inner-wrap">
