...
namespace WBCR\Factory_Freemius_Rio_600;

use WBCR\Factory_Freemius_Rio_600\Sdk\Freemius_Api_WordPress;
use WBCR\Factory_Freemius_Rio_600\Sdk\Freemius_Exception;
...
if ( ! defined( 'FREEMIUS__DIR_SDK' ) ) {
	define( 'FREEMIUS__DIR_SDK', __DIR__ . '/sdk' );
}
...
final class Api {
	...
	/**
	 * @param Wbcr_Factory600_Plugin $slug
	 ...
	 */
	private function __construct( Wbcr_Factory600_Plugin $plugin, $scope, $id, $public_key, $secret_key, $is_sandbox ) {
	 ...
	 * @return Api
	 */
	public static function instance( Wbcr_Factory600_Plugin $plugin, $scope, $id, $public_key, $is_sandbox, $secret_key = false ) {
