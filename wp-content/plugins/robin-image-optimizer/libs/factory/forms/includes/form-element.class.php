...
if ( ! class_exists( 'Wbcr_FactoryForms600_FormElement' ) ) {
	 ...
	 * @since 1.0.0
	 */
	abstract class Wbcr_FactoryForms600_FormElement {
		 ...
		 *
		 * @since 1.0.0
		 * @var Wbcr_FactoryForms600_HtmlAttributeBuilder
		 */
		...
		public function __construct( $options, $form ) {
			...
			$this->html_builder = new Wbcr_FactoryForms600_HtmlAttributeBuilder();
