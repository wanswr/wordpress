...
if ( ! class_exists( 'Wbcr_FactoryForms600_ControlHolder' ) ) {
	/**
	 * The base class for control holders.
	 *
	 * @since 1.0.0
	 */
	abstract class Wbcr_FactoryForms600_ControlHolder extends Wbcr_FactoryForms600_Control {
		 ...
		 *
		 * @since 1.0.0
		 * @return Wbcr_FactoryForms600_FormElement[].
		 */
