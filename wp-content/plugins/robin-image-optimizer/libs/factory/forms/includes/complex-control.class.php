...
if ( ! class_exists( 'Wbcr_FactoryForms600_ComplexControl' ) ) {
	/**
	 * The base class for all controls.
	 *
	 * @since 1.0.0
	 */
	abstract class Wbcr_FactoryForms600_ComplexControl extends Wbcr_FactoryForms600_Control {
