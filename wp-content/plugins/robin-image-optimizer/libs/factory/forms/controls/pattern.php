...
if ( ! class_exists( 'Wbcr_FactoryForms600_PatternControl' ) ) {

	class Wbcr_FactoryForms600_PatternControl extends Wbcr_FactoryForms600_Control {
		...
		public function __construct( $options, $form, $provider = null ) {
			...
			$this->custom_patterns = $this->getOption( 'patterns', [] );
			...
			?>
				<div <?php $this->attrs(); ?>>
					<div class="factory-pattern-controls">
						...
						<a href="#" class="button button-default factory-button factory-change-color-btn 
						<?php
						if ( $hasColor ) {
							echo 'button-active';
						}
						?>
						" title="<?php _e( 'Change color', 'robin-image-optimizer' ); ?>">
							<i class="fa fa-flask"></i>
							<span><?php _e( 're-color', 'robin-image-optimizer' ); ?></span>
						</a>
					...
					<div class="factory-color-panel">
						<div class="factory-color-wrap">
							<span class="factory-color-label"><?php _e( 'Select color:', 'robin-image-optimizer' ); ?></span>
							<?php $this->color->html(); ?>
							<div class="factory-hint">
								<i><?php _e( 'Changing the color may take a minute or more. Please be patient.', 'robin-image-optimizer' ); ?></i>
							</div>
						</div>
