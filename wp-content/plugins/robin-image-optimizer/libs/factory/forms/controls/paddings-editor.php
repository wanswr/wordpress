...
if ( ! class_exists( 'Wbcr_FactoryForms600_PaddingsEditorControl' ) ) {

	class Wbcr_FactoryForms600_PaddingsEditorControl extends Wbcr_FactoryForms600_Control {
			...
			?>
				<div <?php $this->attrs(); ?>
					...
					<div class="factory-slider-container">
						...
						<?php _e( 'Select a side and move the slider to set up:', 'robin-image-optimizer' ); ?>
						</label>
